Rails.application.config.tailwind = OpenStruct.new(
    ...
    h3: {class: "font-bold text-neutral-500 lg:text-2xl text-xl mt-15"}, # mt-15 is from spacing/15 in tailwind.config.js.
    h4: {class: "font-bold text-neutral-500 lg:text-1xl text-xl mt-15"}, # mt-15 is from spacing/15 in tailwind.config.js.
