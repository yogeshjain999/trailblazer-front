module Cms
  module Config
    ...
    TW = OpenStruct.new(
      ...
      h2: {class: "text-2xl font-bold text-neutral-500 lg:text-3xl py-2 flex items-center"}, # is from spacing/15 in tailwind.config.js.
      h3: {class: "font-bold text-neutral-500 lg:text-2xl text-xl py-2 flex items-center"}, # is from spacing/15 in tailwind.config.js.
