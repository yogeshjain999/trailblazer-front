    ...
    module Cell
      ...
      class Section # #Torture::Cms::Section
        ...
        def code_tabs(*args, **kws) # TODO: implement tabs
          ...
          # raise args.inspect
          %(<div class="code-tab-activity code-tab-content">#{code(*args, **kws)}</div>) +
          %(<div class="code-tab-operation code-tab-content hidden">#{code(*args, **kws, file: operation_file)}</div>) +
